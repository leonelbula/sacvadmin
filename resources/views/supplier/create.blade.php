                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="full_name" id="full_name"
                                            ...
                                            value="{{ old('full_name') }}" placeholder="Ej. Distribuciones ABC S.A.S."
                                            required>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="identification_card" id="identification_card"
                                            ...
                                            value="{{ old('identification_card') }}" placeholder="NIT / C.C." required>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="phone" id="phone"
                                            ...
                                            value="{{ old('phone') }}" placeholder="Ej. 300 123 4567">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="address" id="address"
                                            ...
                                            value="{{ old('address') }}" placeholder="Ej. Carrera 10 # 20-30">
                    ...
                    <div class="card border-0 shadow-sm mt-4">
                        ...
                        <div class="card-body p-4">
                            ...
                            <textarea name="description" id="description" rows="4"
                                ...
                                placeholder="Escribe información adicional del proveedor...">{{ old('description') }}</textarea>
                    ...
                    <div class="card border-0 shadow-sm">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="mb-3">
                                ...
                                <label for="departament" class="form-label fw-semibold">
                                ...
                                <input type="text" name="departament" id="departament"
                                    ...
                                    value="{{ old('departament') }}" placeholder="Ej. Córdoba">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="credit_amount" id="credit_amount"
                                    ...
                                    value="{{ old('credit_amount', 0) }}" min="0" step="1"
                                    placeholder="0">
